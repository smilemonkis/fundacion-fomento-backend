...
public class NoticiaService {
    ...
    public NoticiaResponse crear(CreateNoticiaRequest req) {
        Noticia noticia = Noticia.builder()
                ...
                .autor(req.autor())
                .publicado(req.publicado() != null ? req.publicado() : false)
    ...
    public NoticiaResponse actualizar(Integer id, UpdateNoticiaRequest req) {
        ...
        if (req.publicado()         != null) n.setPublicado(req.publicado());
        if (req.fechaPublicacion()  != null) n.setFechaPublicacion(req.fechaPublicacion());
        if (req.galeria()           != null) {
            n.getGaleria().clear();
    ...
    private NoticiaResponse toDto(Noticia n) {
        ...
        return new NoticiaResponse(
                ...
                n.getFechaPublicacion().toString(),
